...
static unsigned int * framePointer0 = (unsigned int *) FRAME_BUFFER_0_ADDR;
static unsigned int * framePointer1 = ((unsigned int *) FRAME_BUFFER_0_ADDR)
		+ 640 * 480;
...
void render_init() {
	...
	const uint32_t alien = bitmaps_getAlien();
	int row = 0, col = 0;
